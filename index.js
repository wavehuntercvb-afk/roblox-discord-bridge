...
client.on(Events.MessageCreate, async (message) => {
  ...
  if (command === "verify") {
    const robloxId = args[0]; // CORRECCIÓN DEFINITIVA: Extraer el primer elemento como texto puro
    ...
    console.log(`[BOT] Registrado con éxito: ${username} -> Roblox: ${robloxId}`);
  }
});
...
// URL DE EMERGENCIA PARA EL NAVEGADOR
